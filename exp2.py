...
trainset = ImageFolderWithPaths(
    root=os.path.join(directory, "../experiment2/training"),
    transform=loader_transform()
)

testset1 = ImageFolderWithPaths(
    root=os.path.join(directory, "../experiment2/test1"),
    transform=loader_transform()
)

testset2 = ImageFolderWithPaths(
    root=os.path.join(directory, "../experiment2/test2"),
    transform=loader_transform()
)
...
class NNModel(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(image_width * image_height, 240)
